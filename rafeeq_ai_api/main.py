...
_KEYWORDS: dict[str, list[str]] = {
    "emergency":      ["نجدة", "ساعدني", "طحت", "وقعت", "إسعاف", "طوارئ", "وجع", "ألم", "مريض", "حادث", "خطر", "إغماء",
                       ...
                       "جتني سخونه", "سخونه قويه", "سخونة قوية", "حرارة عالية", "حراره عاليه", "جتني حراره",
                       "ازهم على الاسعاف", "ازهم الاسعاف", "دق على الاسعاف", "اتصل بالاسعاف"],
    ...
    "medication":     ["دواء", "دوائي", "حبوب", "حبة", "جرعة", "علاج", "صيدلية", "ذكرني بالدواء", "وقت دوائي",
                       "حبوبي", "حبتي", "دواي",
                       "علاجي", "متى اخذ علاجي", "علاجي متى", "وقت علاجي", "موعد علاجي",
                       "ميدي الدكتور", "قال ميدي", "ذكرني بعلاجي"],
    ...
    "islamic_advice": ["نصيحة", "نصيحه", "نصائح", "دعاء", "حديث", "حكمة", "ذكر الله", "استغفر", "علمني دعاء",
                       ...
                       "اذكار الصباح", "أذكار الصباح", "اذكاري الصباح", "اذكاري حقة الصباح",
                       "قولي اذكاري", "قولي اذكار", "اذكار المساء", "أذكار المساء"],
    "locations":      ["مسجد", "مستشفى", "صيدلية", "عيادة", "وين", "أقرب", "دلني", "خريطة", "موقع",
                       "مستوصف", "مركز صحي", "حديقة", "حديقه",
                       "ممشى", "الممشى", "وين اقرب ممشى", "اقرب ممشى"],
    "conversation":   ["قصة", "نكتة", "سولف", "كلمني", "حدثني", "ترفيه", "قولي",
                       ...
                       "علومك", "شلونك", "كيفك دحين", "اشبك اليوم",
                       "تسلم", "ما قصرت", "تسلم ما قصرت", "وش بعد عندك",
                       "قصيده", "قصيدة", "شعر", "اهرج معي", "سولف معي"],
    "general":        [],
}
...
# Common Hijazi words: ايش، دحين، أبغى/تبغى، كمان، مرة.
