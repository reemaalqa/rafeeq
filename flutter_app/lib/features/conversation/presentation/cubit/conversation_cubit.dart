...
class ConversationCubit extends Cubit<ConversationState> {
  ...
  Future<String> _buildSystemInstruction() async {
    ...
    if (userName.isNotEmpty) {
      buf.writeln('اسم المستخدم: $userName. ناده باسمه أحياناً.');
    }
    ...
    switch (dialect) {
      case 'janoubi':
        return 'تحدث باللهجة الجنوبية السعودية (أبها، جازان، نجران). '
            'استخدم كلمات مثل "شبّك؟"، "يا ولدي"، "ابشر"، "والله"، '
            'واختم الكلمات أحياناً بالشين مثل "كيفش" و"وينش".';
      case 'shamali':
        return 'تحدث باللهجة الشمالية السعودية (حائل، الجوف، تبوك). '
            'استخدم "شلونك"، "شخبارك"، "شبيك"، "هلا والله"، '
            'مع نبرة بدوية دافئة.';
      case 'sharqawi':
        return 'تحدث باللهجة الشرقاوية (الدمام، الأحساء، القطيف). '
            'استخدم "شلونك"، "وش أخبارك"، "عاد"، "إي والله"، '
            'مع نغمة خليجية هادئة.';
      case 'najdi':
      default:
        return 'تحدث باللهجة النجدية السعودية (الرياض والقصيم). '
            'استخدم "كيفك"، "وش أخبارك"، "ابشر"، "الله يطول عمرك"، '
            'واختم بعض العبارات بالسين مثل "وينك" و"كيف الحال".';
    }
  }
