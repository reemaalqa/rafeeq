...
class IntentDetector {
  ...
  static const Map<IntentType, List<String>> _keywords = {
    ...
    IntentType.emergency: [
      ...
      // High fever / strong heat
      'جتني سخونه', 'سخونه قويه', 'سخونة قوية', 'حرارة عالية',
      'حراره عاليه', 'جتني حراره', 'جتني حرارة',
      // Ambulance call request (Saudi: "ازهم على الإسعاف")
      'ازهم على الاسعاف', 'ازهم الاسعاف', 'ازهم على الإسعاف',
      'دق على الاسعاف', 'اتصل على الاسعاف', 'اتصل بالاسعاف',
    ],
    ...
    IntentType.medication: [
      ...
      'وش قلت حبوبي', 'وين حبوبي',
      // "علاجي متى اخذه" / "قال ميدي الدكتور اخذ علاجي"
      'علاجي', 'متى اخذ علاجي', 'متى آخذ علاجي', 'علاجي متى',
      'وقت علاجي', 'موعد علاجي', 'ذكرني بعلاجي',
      'ميدي الدكتور', 'قال ميدي', 'ذكرني فيه',
    ],
    ...
    IntentType.diet: [
      ...
      'اسمن', 'انحف', 'ابغى اسمن', 'ابغى انحف', 'زيادة وزن', 'خسارة وزن',
    ],
    ...
    IntentType.reminders: [
      ...
      // Family-related reminders
      'ذكرني ادق على ولدي', 'ذكرني ادق على بنتي',
      'ذكرني اتصل بولدي', 'ذكرني اتصل ببنتي',
      'ذكرني اطمن على ولدي', 'ذكرني اطمن على بنتي',
      'لا تنسى تقولي متى جمعة عيالي', 'متى جمعة عيالي',
      'جمعة عيالي', 'لمة العيال',
      'ذكرني بموعد الدكتور', 'ذكرني بموعد الطبيب',
    ],
    ...
    IntentType.quran: [
      ...
      'فيني اسمع', 'بغيت اسمع',
      'اقرا شي علي من القران', 'اقرا علي من القران',
      'اقرا شي من القران', 'اقرا علي شي',
    ],
    ...
    IntentType.islamicAdvice: [
      ...
      'اذكار', 'أذكار', 'ادعيه', 'ادعية', 'ماشاءالله', 'ماشاء الله',
      // Morning / evening adhkar
      'اذكار الصباح', 'أذكار الصباح', 'اذكاري الصباح',
      'اذكاري حقة الصباح', 'قولي اذكاري', 'قولي اذكار',
    ...
    IntentType.locations: [
      ...
      'مستوصف', 'مركز صحي', 'وين المستوصف', 'اقرب مستوصف',
      'حديقة', 'حديقه', 'وين الحديقة', 'اقرب حديقة', 'ابغى حديقة',
      // Walking path / promenade — Saudi "ممشى"
      'ممشى', 'الممشى', 'وين اقرب ممشى', 'اقرب ممشى', 'ابغى ممشى',
      'وين الممشى',
    ],
  ...
  static const Map<String, String> _dialectMap = {
    ...
    'بغيت': 'أريد',
    'نفسي': 'أريد',
    // Syrian/Lebanese → Saudi/MSA (normalize non-Saudi dialect words)
    'بدي': 'أريد',
    'بدك': 'تريد',
    'بدو': 'يريد',
    // Question words
  ...
  Map<String, String> _extractLocationParams(String normalized, String rawText) {
    ...
    } else if (combined.contains('حديقة') ||
        combined.contains('حديقه') ||
        combined.contains('ممشى') ||
        combined.contains('الممشى')) {
      params['place_type'] = 'park';
    } else if (combined.contains('مستوصف') || combined.contains('مركز صحي')) {
